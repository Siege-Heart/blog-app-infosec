...
const API_BASE = 'http://localhost:5001/api/'; // PORT 5000 → 5001
...
export default function AdminDashboard() {
    ...
    const commentColumns = [
        { key: '_id', label: 'ID', truncate: 8 },
        { key: 'post', label: 'Post ID', truncate: 8 }, // Changed from 'postId' to 'post'
        { key: 'author', label: 'Commenter' }, // Changed from 'user' to 'author'
        { key: 'content', label: 'Comment Text (XSS Field)', truncate: 50 }, // Changed from 'text' to 'content'
    ];
    ...
    return (
        <div className="container mt-5">
            ...
            <p className="text-danger fw-bold">
                Warning: This dashboard displays sensitive and insecure data 
                (e.g., plaintext passwords, XSS/SQLi fields) and should only 
