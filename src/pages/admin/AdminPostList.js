// src/pages/admin/AdminPostList.js
    ...
    return (
        <div className="container mt-5">
            ...
            <p className="text-info">
                This table lists all posts, enabling management. 
                <strong> Edit and Delete functionality requires the backend routes to be implemented/secured.</strong>
            </p>
