// src/pages/admin/CreatePostPage.js
import React, { useState } from 'react';
import { useNavigate } from 'react-router-dom';

const API_URL = "http://localhost:5001/api/blog"; // PORT 5000 → 5001
...
export default function CreatePostPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Use current user's username as author instead of hardcoded 'Admin'
            const postData = {
